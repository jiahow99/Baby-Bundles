...
Route::get('/user/order/details/{order}', [App\Http\Controllers\OrderController::class, 'profile'])->name('order.profile');

Route::get('/order', [App\Http\Controllers\OrderController::class, 'test'])->name('order.profile');
