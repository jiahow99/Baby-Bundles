...
Route::get('/logout', [App\Http\Controllers\Auth\LoginController::class, 'logout'])->name('logout');
Route::get('/test', [App\Http\Controllers\ProductController::class, 'test'])->name('logout');
Route::get('/usr/shop', [App\Http\Controllers\ProductController::class, 'index'])->name('user.shop');
