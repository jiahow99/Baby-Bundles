<div class="mt-3">
    ...
    <div id="price-range-select" class="d-flex align-items-center justify-content-between ">
        <button class="btn btn-outline-primary px-4 py-2"><span class="text-sm">RM 50 - 150</span></button>
        <button class="btn btn-outline-primary px-4 py-2">RM 50 - 150</button>
        <button class="btn btn-outline-primary px-4 py-2">RM 100 - 200</button>
    </div>
    {{-- Price Range --}}
