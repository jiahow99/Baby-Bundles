        ...
        <ul class="navbar-nav ms-auto align-items-lg-center">
          ...
          <li class="nav-item mx-2 dropdown">
            ...
            <div class="dropdown-menu mt-lg-3 text-sm bg-light bg-opacity-75" aria-labelledby="navbarDropdownMenuLink" id="dropdown-menu">
              <a class="dropdown-item" href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}">Top</a>
              <a class="dropdown-item" href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}">Bottom</a>
              <a class="dropdown-item" href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}">Socks</a>
              <a class="dropdown-item" href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}">Shoes</a>
              <a class="dropdown-item" href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}">Accessories</a>
            </div>
          </li>
          <li class="nav-item mx-2">
            <script>
