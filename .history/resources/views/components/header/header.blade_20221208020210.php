          ...
          <li class="nav-item ms-3">
            ...
            <li>
                <a class="btn btn-outline-dark px-4 ms-lg-3 py-2" href="{{route('user.cart')}}" style="padding-top: 0.37rem;padding-bottom: 0.37rem;">
                    Cart
                    <span class="badge bg-dark text-white ms-1 rounded-pill" id="cartItemQuantity">{{Auth::user()->cart->product_qty}}</span>
                </a>
            </li>
            ...
            @else
              <li><a href="#" class="btn btn-outlin-light ms-4 px-4">Sign In</a></li>
