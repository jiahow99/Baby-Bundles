        ...
        <ul class="navbar-nav ms-auto align-items-lg-center">
          ...
          <li class="nav-item mx-2 dropdown">
            ...
            <div class="dropdown-menu mt-lg-3 text-sm bg-light bg-opacity-75" aria-labelledby="navbarDropdownMenuLink" id="dropdown-menu">
              <a class="dropdown-item" href="{{route('category.top')}}">Top</a>
              {{-- <a class="dropdown-item" href="{{route('category.bottom')}}">Bottom</a>
              <a class="dropdown-item" href="{{route('category.outfit')}}">Socks</a>
              <a class="dropdown-item" href="{{route('category.accessories')}}">Shoes</a>
              <a class="dropdown-item" href="{{route('category.shoes')}}">Accessories</a> --}}
            </div>
          </li>
          <li class="nav-item mx-2">
            <script>
          ...
          <li class="nav-item ms-lg-3 ps-lg-3 width-auto">
            <a class="btn btn-primary px-4" href="contact-form.php#contact-form">Contact Us</a>
          </li>
