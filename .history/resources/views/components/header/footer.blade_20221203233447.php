<footer class="bg-dark">
      ...
      <div class="row py-5">
        ...
        <div class="col-lg-2 col-md-6">
          ...
          <ul class="list-unstyled">
            ...
            <li class="mb-2"><a class="footer-link" href="top.php">Top</a></li>
            <li class="mb-2"><a class="footer-link" href="bottom.php">Bottom</a></li>
            <li class="mb-2"><a class="footer-link" href="contact-form.php">Contacts</a></li>
          </ul>
        </div>
  ...
  <div class="bg-darker py-4">
    <div class="container text-center">
      ...
      <p class="mb-0 text-muted text-sm">&copy; All rights reserved. by Baby Bundles</p>
    </div>
  </div>
</footer>