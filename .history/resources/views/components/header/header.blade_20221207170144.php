    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto align-items-lg-center">
          ...
          <!-- if logged in -->
            <li>
                <a class="btn btn-outline-dark px-4 ms-lg-3 py-2" href="shopping-cart.php" style="padding-top: 0.37rem;padding-bottom: 0.37rem;">
                    Cart
                    <span class="badge bg-dark text-white ms-1 rounded-pill">11</span>
                </a>
            </li>
