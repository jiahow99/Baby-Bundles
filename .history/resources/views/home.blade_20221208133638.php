                ...
                <div class="card-body pt-3 pb-3" >
                    <div>
                        ...
                        <div class="row " style="height:40px;">
                            <h6 class="justify-content-start col-10 text-black">{{mb_strimwidth("sadacsdaxd", 0, 38, "...")}}</h6>
                            <!-- Favourite icon -->
            ...
            <div class="product card border-0" style="width:280px;">
                ...
                <div class="card-body pt-3 pb-3" >
                    <div>
                        <!-- Product name-->
                        <div class="row " style="height:40px;">
                            <h6 class="justify-content-center col-12 text-black">{{mb_strimwidth("sadacsdaxd", 0, 38, "...")}}</h6>
                        </div>
