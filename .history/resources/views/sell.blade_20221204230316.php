...
<head>
    ...
    <!-- Main CSS-->
    <link href="{{route('css/upload-product.css')}}" rel="stylesheet">
    <link href="{{route('css/style.default.css')}}" rel="stylesheet">
    <link href="{{route('css/header-style.css')}}" rel="stylesheet">
</head>
