                    ...
                    <div class="card mt-4" id="order-detail-products">
                      ...
                      {{-- <div class="d-flex justify-content-between pe-5">
                        <div class="d-flex align-items-center">
                          ...
                          <!-- Product Title -->
                          <div class="ms-4">
                            <p class="row product-title mb-0">Product Title</p>
                            <p class="row text-muted small">Category: </p>
                          </div>
                        </div>
                        <!-- Product Price -->
        ...
        $.ajax({
          ...
          success:function(data)
          {
            ...
            for(i=0 ; i<len; i++){
              ...
              '<div class="ms-4">' +
              '<p class="row product-title mb-0">' + data[i].title + '</p>' +
              '<p class="row text-muted small">Category: '+ data[i].category.name +'</p></div></div>' +
              '<div class="d-flex align-items-center"><span class="product-price">RM ' + data[i].price + '</span></div></div>'
