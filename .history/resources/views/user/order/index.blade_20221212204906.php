    ...
    $(document).ready(function(){
      $('body').on('click', '#trackbtn', function(){
        ...
        $('#orderDetailsModal').modal('show');
          // Modal Data
          // $.each(productsURL), function( index, value ){
          //   var html = '<div class="d-flex justify-content-between pe-5">' +
          //     '<div class="d-flex align-items-center">' +
          //     '<img src="' + productsURL.image + '" width="120" alt="">' +
          //     '<span>' + productsURL.title + '</span></div>' +
          //     '<div class="d-flex align-items-center"><span>RM ' + productsURL.price + '</span></div></div></div>' ;
          //     $('#order-detail-products').append(html);
          // }

          $.each(productsURL), function( index, value ){console.log(value)};
      })
    });
  </script>
