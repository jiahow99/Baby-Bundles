...
<html>
    ...
    <body>
        ...
        {{-- Order Details Modal --}}
        <section class="vh-100" id="order-details-modal" style="background-color: #35558a;">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body text-start text-black p-4">
                          <h5 class="modal-title text-uppercase mb-5" id="orderDetailsLabel">Johnatan Miller</h5>
    ...
    @if (session('order-placed'))
        <script>
            ...
            document.getElementById("order-placed").click();
