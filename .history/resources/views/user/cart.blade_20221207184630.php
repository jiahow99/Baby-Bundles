        ...
        <div class="card mt-6"  >
            <div class="row">
                <div class="col-md-8 cart" id="shopping-cart">
                    <div class="title">
                        ...
                        <div class="row">
                            ...
                            <!-- Total item quantity -->
                            <div class="col align-self-center text-right text-muted">123 items</div>
                        </div>
                    </div>
                    ...
                    <div class="back-to-shop">
                        <a href="shopping-page.php">&leftarrow;<span class="text-muted ml-1">Back to shop</span>
                        </a>
                    </div>
                ...
                <div class="col-md-4 summary">
                    ...
                    <div class="row">
                        <!-- Total Item Quantity -->
                        <div class="col text-lg">Quantity : 123</div>
                    </div>
                    <div>
