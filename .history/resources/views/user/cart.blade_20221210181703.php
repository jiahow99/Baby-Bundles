    ...
    <body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body text-start text-black p-4">
                <h5 class="modal-title mb-5" id="orderDetailsLabel">ORDER ID: <span class="orderid">{{str_pad(session('order')['id'], 8, '0', STR_PAD_LEFT);}}</span></h5>
                ...
                <p class="small">RM 57.00</p>
                </div>

                <div class="d-flex justify-content-between">
                <p class="fw-bold">Total</p>
                <p class="fw-bold text-lg" style="color: #35558a;">RM 129.30</p>
                </div>
            </div>
            
            <div class="modal-footer d-flex justify-content-center border-top-0 py-4">
                <button type="button" class="btn text-white btn-lg mb-1" style="background-color: #35558a;">
                Track order
                </button>
            </div>
            </div>
