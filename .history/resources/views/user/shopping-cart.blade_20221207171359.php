        ...
        <div class="card mt-6"  >
            <div class="row" style="height:80vh;">
                <div class="col-md-8 cart" id="shopping-cart">
                    <div class="title">
                        ...
                        <div class="row">
                            ...
                            <!-- Total item quantity -->
                            <div class="col align-self-center text-right text-muted">{{count($product_items)}} items</div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 summary">
                    ...
                    <div class="row">
                        <!-- Total Item Quantity -->
                        <div class="col text-lg">Quantity : <?php if(isset($quantity)){echo $quantity;}else{echo '0';} ?></div>
                    </div>
                    <div>
                    ...
                    <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                        ...
                        <div id="total-price" class="col text-right" style="font-size:20px;">RM <?php if(isset($totalPrice)){echo $totalPrice;}else{echo '0.00';} ?></div>
                    </div>
