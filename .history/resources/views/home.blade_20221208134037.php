...
<html>
  ...
  <body>
    ...
    <section class=" bg-light" id="categories">
      ...
      <div class="mx-5 mt-4">
        <div class="col-12">
          <a href="{{route('product.index', Category::whereSlug('outfit')->first()->id)}}" style="height:400px" class="category card overflow-hidden">
        ...
        <div class="row g-0">
            <div class="col-6">
                <div class="row justify-content-center">
                    <div class="col-12">
                      <a href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}" style="height:350px" class="category card overflow-hidden">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                      <a href="{{route('product.index', Category::whereSlug('shoes')->first()->id)}}" style="height:350px" class="category card overflow-hidden">
            ...
            <div class="col-6 text-center">
                <div class="row justify-content-center">
                    <div class="col-12">
                      <a href="{{route('product.index', Category::whereSlug('top')->first()->id)}}" style="height:700px" class="category card overflow-hidden">
    ...
    <section id="featured-product">
      <div class="container">
        <p class="h4 mt-4 text-uppercase text-primary mb-3 text-center">Featured Product</p>
        <div class="row">
          <div class="col-3 mb-4">
            <div class="product card border-0" style="width:280px;">
                <!-- Product image-->
                <div class="overflow-hidden">
                    <a href='#'><img class='card-img-top' style='width:300px;height:300px;' src='{{asset('img/top/top01.jpg')}}'></a>
                </div>
          ...
          <div class="col-3 mb-4">
            <div class="product card border-0" style="width:280px;">
                <!-- Product image-->
                <div class="overflow-hidden">
                    <a href='#'><img class='card-img-top' style='width:300px;height:300px;' src='{{asset('img/top/top02.jpg')}}'></a>
                </div>
          ...
          <div class="col-3 mb-4">
            <div class="product card border-0" style="width:280px;">
                <!-- Product image-->
                <div class="overflow-hidden">
                    <a href='#'><img class='card-img-top' style='width:300px;height:300px;' src='{{asset('img/bottom/bottom01.jpg')}}'></a>
                </div>
          ...
          <div class="col-3 mb-4 gx-0">
            <div class="product card border-0" style="width:280px;">
                <!-- Product image-->
                <div class="overflow-hidden">
                    <a href='#'><img class='card-img-top' style='width:300px;height:300px;' src='{{asset('img/socks/socks1.jpg')}}'></a>
                </div>
                <div class="card-body pt-3 pb-3" >
                    <div>
                        <!-- Product name-->
                        <div class="row" style="height:20px;">
                            <h6 class="justify-content-start col-10">{{mb_strimwidth("This is a product", 0, 38, "...")}}</h6>
                            <!-- Favourite icon -->
