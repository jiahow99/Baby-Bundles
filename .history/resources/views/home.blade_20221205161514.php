...
<html>
  ...
  <body>
    ...
    <section class=" bg-light" id="categories">
      ...
      {{-- <div class="row justify-content-center py-5" align="center" style="gap:4rem;">
        <!-- Top (Category) -->
        <div class="col-3">
          <a href="{{route('product.index', Category::whereSlug('top')->first()->id)}}" class="category card overflow-hidden">
        ...
        <!-- Bottom (Category) -->
        <div class="col-3">
          <a href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}" class="category card overflow-hidden">
        ...
        <!-- Outfit (Category) -->
        <div class="col-3">
          <a href="{{route('product.index', Category::whereSlug('outfit')->first()->id)}}" class="category card overflow-hidden">
        ...
        <!-- Shoes (Category) -->
        <div class="col-3">
          <a href="{{route('product.index', Category::whereSlug('shoes')->first()->id)}}" class="category card overflow-hidden">
