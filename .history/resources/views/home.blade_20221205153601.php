        ...
        <div class="row g-0">
            <div class="col-6">
                <div class="row justify-content-center">
                    <div class="col-12">
                      <a href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}" style="height:320px" class="category card overflow-hidden">
                        <img src="img/bottom.jpg" class="card-img" alt="">
                        <div class="card-img-overlay d-flex align-items-center justify-content-center p-0">
                          <h2 class="card-title display-6 text-light fw-normal underline">Bottom</h2>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                      <a href="{{route('product.index', Category::whereSlug('shoes')->first()->id)}}" style="height:320px" class="category card overflow-hidden">
                        <img src="img/shoes.jpg" class="card-img" alt="">
                        <div class="card-img-overlay d-flex align-items-center justify-content-center p-0">
                          <h2 class="card-title display-6 text-white fw-normal  underline">Shoes</h2>
                        </div>
