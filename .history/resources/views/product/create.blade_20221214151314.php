                ...
                <div class="upload-card-body">
                    ...
                    <form method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="title" placeholder="Enter product title" value="{{ old('username') }}" autofocus>
                                <!-- Error Message -->
                                @error('title')
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="description" placeholder="Say something about your product">{{ old('description') }}</textarea>
                                </div>
                                <!-- Error Message -->
                                @error('description')
                                    <div class="text-danger text-md fw-bold">{{$message}}</div>
                            ...
                            <div class="name text-uppercase">Price</div>
                                <div class="value">
                                    <div class="d-flex">
                                        ...
                                        <input class="input--style-6" type="text" name="price" placeholder="0.00" value="{{ old('username') }}">
                                    </div>
                                    <!-- Error Message -->
                                    @error('price')
                                        <div class="text-danger text-sm">
