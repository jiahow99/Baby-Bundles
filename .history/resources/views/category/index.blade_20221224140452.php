<x-category-master>
    ...
    <div class="row justify-content-start" x-data="{products: {{$products}}}">
        ...
        <!-- Modal View -->
        <div class="modal fade bd-example-modal-lg" x-on:open-modal.window="modal('show')" id="productShowModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
