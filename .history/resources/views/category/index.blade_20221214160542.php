    ...
    @section('script')
        ...
        $(document).ready(function(){
            $('body').on('click', '#show-product', function(){
                ...
                // });
                $('#product-id').val(productURL.id)
                $('#product-title').text(productURL.title);
                $('#product-description').text(productURL.description);
                $('#product-price').text("RM " + productURL.price.toFixed(2));
                $('#product-category').text("Category: " + productURL.category.name);
                $('#main_product_image').attr('src', productURL.image);
                $('#preview_product_image_1').attr('src', productURL.image);
                $('#preview_product_image_2').attr('src', productURL.image);
                $('#preview_product_image_3').attr('src', productURL.image);
                $('#preview_product_image_4').attr('src', productURL.image);
