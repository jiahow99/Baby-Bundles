<x-category-master>
    ...
    <div class="row justify-content-start" x-data="{products: {{$products}}}">
        @foreach ($products as $product_item)
            <div x-data x-on:click="console.log($refs.modal_title)" class="col-3 mb-4">
                <div class="product card border-0" style="width:250px;">
                    ...
                    <div class="overflow-hidden">
                        ...
                        >
                            <img class='card-img-top' style='width:250px;height:260px;' x-bind:src='src'>
                        </a>
                    </div>
                    <!-- Product details-->
                    <div class="card-body pt-3 pb-3" style="height:120px;">
                        <div>
                            ...
                            <div class="row " style="height:40px;">
                                <h6 class="justify-content-start col-10 product-title-card">{{$product_item->title}}</h6>
                                <!-- Favourite icon -->
