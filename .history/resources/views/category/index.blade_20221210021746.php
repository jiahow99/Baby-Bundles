<x-category-master>
    ...
    <div class="row justify-content-start">
        ...
        <!-- Modal View -->
        <div class="modal bd-example-modal-lg" id="productShowModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
