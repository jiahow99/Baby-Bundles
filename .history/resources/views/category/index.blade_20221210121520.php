<x-category-master>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="thumbnail_images row">
                                <ul id="thumbnail">
                                    ...
                                    <li>
                                        <img onclick="changeImage(this)" id="preview_product_image" src="{{asset('img/top/top02.jpg')}}" width="70">
                                    </li>
                                    <li>
                                        <img onclick="changeImage(this)" id="preview_product_image" src="{{asset('img/top/top03.jpg')}}" width="70">
                                    </li>
                                    <li>
                                        <img onclick="changeImage(this)" id="preview_product_image" src="{{asset('img/top/top04.jpg')}}" width="70">
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    @section('script')
        ...
        $(document).ready(function(){
            ...
            $('body').on('click', '#preview_product_image_1', function(){
                var main_product_image = $('#main_product_image').attr('src');
                var preview_product_image_1 = $('#preview_product_image_1').attr('src');
                $('#main_product_image').attr('src', preview_product_image_1);
                $('#preview_product_image_1').attr('src', main_product_image);
            });


            $('body').on('click', '#preview_product_image', function(){
                var preview_product_image = $('#preview_product_image').attr('src');
                $('#main_product_image').attr('src', preview_product_image);
            });
