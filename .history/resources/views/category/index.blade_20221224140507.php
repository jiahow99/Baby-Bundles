<x-category-master>
    ...
    <div class="row justify-content-start" x-data="{products: {{$products}}}">
        @foreach ($products as $product_item)
            <div x-data x-on:click="$dispatch('open-modal');$refs.modal_title.text = {{$product_item->title}}" class="col-3 mb-4">
        ...
        <!-- Modal View -->
        <div class="modal fade bd-example-modal-lg" x-on:open-modal.window="console.log('123') id="productShowModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <div class="col-lg-7 ">
                            <div class="mt-5">
                                ...
                                <div class="col-10 d-flex justify-content-start">
                                    <p x-ref="modal_title" id="product-title" class="product-title"></p>
                                </div>
                                <!-- Favourite action -->
