            ...
            <div class="col-3 mb-4">
                <div class="product card border-0" style="width:250px;">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <img class='card-img-top' style='width:250px;height:260px;' src='{{$product_item->images->first()->src ?? ""}}' data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
                    </div>
                    <!-- Product details-->
                        ...
                        <div class="col-lg-7 p-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-10 d-flex justify-content-start">
                                    <h2 class="product-title">This is title</h2>
                                </div>
                                <!-- Favourite action -->
                                <i class='bx bx-heart col' style="font-size: 30px;"></i>
                            </div>

                            <div class="text-muted d-flex" style="font-size:14px">Category: Top</div>
