        ...
        <div class="row g-0">
            <div class="col-6">
                <div class="row justify-content-center">
                    <div class="col-12">
                      <a href="{{route('product.index', Category::whereSlug('bottom')->first()->id)}}" style="height:400px" class="category card overflow-hidden">
                        <img src="img/bottom.jpg" class="card-img" alt="">
                        <div class="card-img-overlay d-flex align-items-center justify-content-center p-0">
                          <h2 class="card-title display-6 text-light fw-normal underline">Bottom</h2>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <a href="top.php" class="category card overflow-hidden" style="height: 320px;">
                          <img src="img/top.jpg" class="card-img" alt="">
                          <div class="card-img-overlay d-flex align-items-center justify-content-center p-0">
                            <h2 class="card-title display-5 text-white fw-normal  underline">Bottom</h2>
                          </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-6 text-center">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <a href="top.php" class="category card overflow-hidden" style="height: 640px;">
                          <img src="img/top.jpg" class="card-img" alt="">
                          <div class="card-img-overlay d-flex align-items-center justify-content-center p-0">
                            <h2 class="card-title display-5 text-white fw-normal  underline">Top</h2>
                          </div>
