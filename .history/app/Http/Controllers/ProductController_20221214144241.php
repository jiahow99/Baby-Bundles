...
class ProductController extends Controller
{
    ...
    public function store(){
        ...
        if(request()->hasFile('image')){
            ...
            // Storage::disk('local')->put( 'image' , $filename);

            $directory = 'public/images/'.request('category').
            $path = request('image')->storeAs('images', request('image')->getClientOriginalName(), 'public');
            dd($path);
